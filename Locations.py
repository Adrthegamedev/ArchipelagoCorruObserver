...
location_table = {
    ...
    "Memory Hole: Effigy: Sipper Effigy Unitied": LocationData(154140084, "Memory Hole"), # Sipper effigy unitied
    ...
    "Visited: /local/uncosm/effigy/": LocationData(154140906, "Memory Hole"),
...
def getrules(world: "CorruObserverWorld"):
    return {
        ...
        "Beneath intro dialogue": lambda state: ((state.can_reach_region("Beneath", world.player) or state.can_reach_region("Beneath Depths", world.player) or state.can_reach_region("Parasite Plane", world.player))),
        "Beneath: nothanks.png": lambda state: state.has("Jokzi Ozo: Unity Mask", world.player),
        "Dull Vessel: Akizet's Room": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "Dull Vessel: Destroyed Dull Vessel": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "First Chat (Incoherent): Dying to Ghost": lambda state: (((state.can_reach_region("Clemens Romanus", world.player) and state.has("Menu: EP2 Intro", world.player)) or state.has("Jokzi Ozo: Hunger Mask", world.player)) and state.has("First Chat: Be Honest", world.player)),
        "First Chat (Incoherent): Seen Ghost": lambda state: (((state.can_reach_region("Clemens Romanus", world.player) and state.has("Menu: EP2 Intro", world.player)) or state.has("Jokzi Ozo: Hunger Mask", world.player)) and state.has("First Chat: Be Honest", world.player)),
        "First Chat (Incoherent): Interview Lady Unitied": lambda state: (((((state.can_reach_region("Clemens Romanus", world.player) and state.has("Menu: EP2 Intro", world.player)) or state.has("Jokzi Ozo: Hunger Mask", world.player)) and state.has("First Chat: Be Honest", world.player))) and state.has("Jokzi Ozo: Unity Mask", world.player)),
        ...
        "City Streets: Isabel Unitied": lambda state: ((state.can_reach_region("Beneath", world.player)) or state.has("Menu: EP2 Intro", world.player)) and state.has("Jokzi Ozo: Unity Mask", world.player),
        "City Streets: Fawners Effigies Unitied": lambda state: ((state.can_reach_region("Beneath", world.player)) or (state.has("Menu: EP2 Intro", world.player) and state.has("Jokzi Ozo: Hunger Mask", world.player))) and state.has("Jokzi Ozo: Unity Mask", world.player),
        ...
        "Jokzi Ozo: Event: Dark room - stow": lambda state: state.has("City Streets: Isabel Unitied", world.player) and state.has("::/FRAME/: Won Escape", world.player),
...
def getscansanityrules(world: "CorruObserverWorld"):
    return {
        ...
        "Examined: ..__CITY_SURFACE__..: beautiful parasite": lambda state: ((state.can_reach_region("Beneath", world.player)) or state.has("Menu: EP2 Intro", world.player)),
        ...
        "Examined: ..__OUR_DULL_VESSEL__..: workspace": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "Examined: ..__OUR_DULL_VESSEL__..: translation slab": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "Examined: ..__OUR_DULL_VESSEL__..: column": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "Examined: ..__OUR_DULL_VESSEL__..: bright ground-parasite": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "Examined: ..__OUR_DULL_VESSEL__..: advanced rejuvenation chamber": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "Examined: ..__OUR_DULL_VESSEL__..: high-pressure body": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "Examined: ..__OUR_DULL_VESSEL__..: personal storage": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
        "Examined: ..__OUR_DULL_VESSEL__..: equipment storage": lambda state: ((state.has("Menu: EP1 Fed", world.player)) and state.has("Jokzi Ozo: Hunger Mask", world.player)) or state.can_reach_region("Beneath", world.player),
...
# 
# modrules = {
#     "First Chat (Incoherent, Funnier Maze): Caged Demon": lambda state: (((state.can_reach_region("Clemens Romanus", world.player) and state.has("Menu: EP2 Intro", world.player)) or state.has("Jokzi Ozo: Hunger Mask", world.player)) and state.has("First Chat: Be Honest", world.player)),
#     "First Chat (Incoherent, Funnier Maze): Demon Unitied": lambda state: (((((state.can_reach_region("Clemens Romanus", world.player) and state.has("Menu: EP2 Intro", world.player)) or state.has("Jokzi Ozo: Hunger Mask", world.player)) and state.has("First Chat: Be Honest", world.player))) and state.has("Jokzi Ozo: Unity Mask", world.player)),
#     "First Chat (Incoherent, Funnier Maze): Reached End": lambda state: (((state.can_reach_region("Clemens Romanus", world.player) and state.has("Menu: EP2 Intro", world.player)) or state.has("Jokzi Ozo: Hunger Mask", world.player)) and state.has("First Chat: Be Honest", world.player)),
