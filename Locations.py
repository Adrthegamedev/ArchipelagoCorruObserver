...
def getrules(world: "CorruObserverWorld"):
    return {
        ...
        "Effigy seen": lambda state: ((state.can_reach_region("City Streets", world.player) and ((logic.canAccessCityStreetIsabel(state, world.player) and state.has("Jokzi Ozo: Hunger Mask", world.player)))) or (state.can_reach_region("Beneath", world.player)) or (state.can_reach_region("Memory Hole (Effigy)", world.player)) or (state.can_reach_region("Parasite Plane", world.player) and state.has("Hub: Framing Device Installation", world.player)) or (state.can_reach_region("Jokzi Ozo", world.player) and state.has("City Streets: Isabel Unitied", world.player))),
